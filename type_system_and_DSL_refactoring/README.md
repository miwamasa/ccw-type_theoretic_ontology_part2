...
- `../type_inhabitation_DSL/`: 現在の実装
- `../doc/product_type_guide.md`: Product型の詳細ガイド
- `../doc/multiarg_implementation_cost_analysis.md`: 多引数関数の実装コスト分析
- `../doc/dsl_guide.md`: DSL完全ガイド
- `../theory/`: 理論的背景（型理論、圏論）

## 連絡先

質問や提案がある場合は、GitHubのissueで議論してください。

---

**Note**: このディレクトリは、システムの根本的なリファクタリングを目的としています。現在の実装を拡張するのではなく、より洗練された設計で再実装することを推奨します。
